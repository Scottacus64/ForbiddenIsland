    ...
    if (clickedCard) 
    {
        ...
        else if(firstChar == 'D')
        {
            ...
            else 
            {
                ...
                std::cout << "**** CardClicked cardsDelt = " << cardsDelt << " dpSize = " << dpSize << "\n";
    ...
    if (cDelt > 0)
        {
            ...
            std::cout << "** UpdateDecks cards delt = " << cDelt << " dpSize = " << dpSize <<"\n";
            ...
            drawPileFlag = true;
            std::cout << "**** UpdateDecks dpSize = " << dpSize << " cardsDelt = " << cardsDelt << "\n";
        }
        else
        {
